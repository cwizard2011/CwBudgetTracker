...
const en: Dictionary = {
  ...
  'settings.backup.description': 'Create a backup file and copy it to your new phone. On the new phone, place that file in Downloads and tap Restore Latest Backup.',
